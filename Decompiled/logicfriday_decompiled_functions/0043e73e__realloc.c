    ...
    if (_NewSize == 0) {
        ...
        if (_NewSize < (uint *)0xffffffe1) {
          ...
          if (local_24 != (uint *)0x0) {
            ...
            if (local_20 == (int *)0x0) {
              ...
              local_20 = HeapAlloc(DAT_0046cd6c,0,_NewSize);
              if (local_20 != (int *)0x0) {
                puVar3 = (uint *)(*(int *)((int)_Memory + -4) - 1);
                if (_NewSize <= puVar3) {
                  puVar3 = (uint *)_NewSize;
          ...
          if (local_24 == (uint *)0x0) {
            ...
            _NewSize = _NewSize + 0xf & 0xfffffff0;
            local_20 = HeapReAlloc(DAT_0046cd6c,0,_Memory,_NewSize);
          }
        }
        if (local_20 != (int *)0x0) {
          return local_20;
      ...
      do {
        ...
        if (_NewSize < 0xffffffe1) {
          ...
          pvVar4 = HeapReAlloc(DAT_0046cd6c,0,_Memory,_NewSize);
        }
