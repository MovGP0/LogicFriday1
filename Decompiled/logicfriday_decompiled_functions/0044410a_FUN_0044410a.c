/* 0044410a FUN_0044410a */

/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

int __cdecl FUN_0044410a(uint param_1,char *param_2,uint param_3)

{
  ...
  piVar5 = &DAT_0046cc40 + ((int)param_1 >> 5);
    ...
    if (param_3 != 0) {
      do {
        ...
        if (((int)local_20 < (int)pcVar3 - (int)local_424) ||
           (param_3 <= (uint)((int)local_14 - (int)param_2))) goto LAB_0044420c;
      } while( true );
    }
  }
