...
use crate::enc::dic_to_sm;
use crate::enc::gen_eqn;
use crate::enc::input;
use crate::mincov::mincov;
use crate::stg::stg::{Stg, StgError};
...
pub fn astg_encode(stg: &mut Stg, heuristic: bool) -> Result<AstgEncodeResult, SiEncodeError>
{
    match stg.num_states()
    {
        ...
        2 =>
        {
            stg.set_state_encoding(crate::stg::stg::StateId(0), "0")?;
            stg.set_state_encoding(crate::stg::stg::StateId(1), "1")?;
...
) -> Result<(), SiEncodeError>
{
    ...
    {
        stg.set_state_encoding(crate::stg::stg::StateId(state_index), code)?;
    }
