...

{
  ...
  if ((local_8 & 1) == 0) {
    ...
    *piVar4 = *piVar4 + -1;
    if (*piVar4 == 0) {
      if (DAT_0046cd50 != (uint *)0x0) {
        VirtualFree((LPVOID)(DAT_0046cd68 * 0x8000 + DAT_0046cd50[3]),0x8000,0x4000);
        DAT_0046cd50[2] = DAT_0046cd50[2] | 0x80000000U >> ((byte)DAT_0046cd68 & 0x1f);
        *(undefined4 *)(DAT_0046cd50[4] + 0xc4 + DAT_0046cd68 * 4) = 0;
        *(char *)(DAT_0046cd50[4] + 0x43) = *(char *)(DAT_0046cd50[4] + 0x43) + -1;
        if (*(char *)(DAT_0046cd50[4] + 0x43) == '\0') {
          DAT_0046cd50[1] = DAT_0046cd50[1] & 0xfffffffe;
        }
        if (DAT_0046cd50[2] == 0xffffffff) {
          VirtualFree((LPVOID)DAT_0046cd50[3],0,0x8000);
          HeapFree(DAT_0046cd6c,0,(LPVOID)DAT_0046cd50[4]);
          _memmove(DAT_0046cd50,DAT_0046cd50 + 5,
                   (DAT_0046cd54 * 0x14 - (int)DAT_0046cd50) + -0x14 + DAT_0046cd58);
          DAT_0046cd54 = DAT_0046cd54 + -1;
          if (DAT_0046cd50 < param_1) {
            param_1 = param_1 + -5;
          }
          DAT_0046cd60 = DAT_0046cd58;
        }
      }
      DAT_0046cd50 = param_1;
      DAT_0046cd68 = uVar14;
    }
  }
  return;
