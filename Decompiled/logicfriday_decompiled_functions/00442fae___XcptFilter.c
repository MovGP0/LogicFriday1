...

{
  ...
  do {
    ...
    puVar9 = puVar9 + 3;
  } while (puVar9 < puVar1 + DAT_0045218c * 3);
  if ((puVar1 + DAT_0045218c * 3 <= puVar9) || (*puVar9 != _ExceptionNum)) {
    puVar9 = (ulong *)0x0;
  }
  if ((puVar9 == (ulong *)0x0) || (pcVar2 = (code *)puVar9[2], pcVar2 == (code *)0x0)) {
    ...
    if (pcVar2 != (code *)0x1) {
      ...
      if (puVar9[1] == 8) {
        if (DAT_00452180 < DAT_00452184 + DAT_00452180) {
          iVar8 = DAT_00452180 * 0xc;
          iVar7 = DAT_00452180;
          do {
            *(undefined4 *)(iVar8 + 8 + (int)p_Var6->_initaddr) = 0;
            iVar7 = iVar7 + 1;
            iVar8 = iVar8 + 0xc;
          } while (iVar7 < DAT_00452184 + DAT_00452180);
        }
        uVar4 = *puVar9;
