...
/* 00447b69 FID_conflict:__ld12tod */
...

{
  ...
  IVar1 = __ld12cvt((ushort *)_Ifp,(uint *)_D,(int *)&DAT_00452538);
  return IVar1;
}



/* 00447b7f FID_conflict:__ld12tod */
...

{
  ...
  IVar1 = __ld12cvt((ushort *)_Ifp,(uint *)_D,(int *)&DAT_00452550);
  return IVar1;
}
