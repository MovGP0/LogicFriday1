/* 004406e3 FUN_004406e3 */

uint __thiscall FUN_004406e3(void *this,uint param_1,uint param_2)
  ...
  if ((*(int *)(param_1 + 0x14) == 0) || ((*(int *)(param_1 + 0x24) != 0 && (param_2 < 0x80)))) {
    ...
    if (param_2 < 0x100) {
      if (*(int *)(param_1 + 0x28) < 2) {
        ...
        uVar3 = FUN_00443fdc(this,param_1,param_2,1);
      }
      if (uVar3 == 0) {
        return uVar2;
      }
    ...
    iVar4 = ___crtLCMapStringA(*(_locale_t *)(uVar1 + 0x14),(LPCWSTR)0x100,(DWORD)&param_1,_LpSrcStr
                               ,(int)&local_8,(LPSTR)0x3,*(int *)(uVar1 + 4),1,unaff_EDI);
    if (iVar4 != 0) {
      if (iVar4 != 1) {
