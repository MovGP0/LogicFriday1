/* 0040b4ed FUN_0040b4ed */

undefined4 FUN_0040b4ed(void)
    ...
    *(undefined4 *)((int)DAT_004528a4 + *(int *)(unaff_EBP + -0x10) * 0x118 + 0x110) =
    ...
    if (*(int *)((int)DAT_004528a4 + *(int *)(unaff_EBP + -0x10) * 0x118 + 0x110) == 0) {
      ...
      FUN_0043ebd0((uint *)((int)DAT_004528a4 + *(int *)(unaff_EBP + -0x10) * 0x118),
                   (uint *)&DAT_0044ad26);
      *(undefined4 *)((int)DAT_004528a4 + *(int *)(unaff_EBP + -0x10) * 0x118 + 0x114) = 0;
      FUN_0041d944(*(void **)((int)DAT_004528a4 + *(int *)(unaff_EBP + -0x10) * 0x118 + 0x110),
